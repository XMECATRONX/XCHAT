...
CREATE TABLE "User" (
    ...
    "solanaAddress" TEXT,
    "isVerifiedKYC" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "Transaction_currentHash_key" ON "Transaction"("currentHash");
...
-- CreateIndex
CREATE INDEX "MediaPack_creatorId_idx" ON "MediaPack"("creatorId");

-- CreateIndex
CREATE INDEX "MediaItem_creatorId_idx" ON "MediaItem"("creatorId");

-- CreateIndex
CREATE INDEX "MediaItem_packId_idx" ON "MediaItem"("packId");

-- CreateIndex
CREATE INDEX "MediaItem_createdAt_idx" ON "MediaItem"("createdAt");

-- CreateIndex
CREATE INDEX "FlashSale_creatorId_idx" ON "FlashSale"("creatorId");

-- CreateIndex
CREATE INDEX "FlashSale_expiresAt_idx" ON "FlashSale"("expiresAt");

-- CreateIndex
CREATE UNIQUE INDEX "MediaUnlock_transactionId_key" ON "MediaUnlock"("transactionId");

-- CreateIndex
CREATE INDEX "MediaUnlock_userId_idx" ON "MediaUnlock"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "MediaUnlock_mediaItemId_userId_key" ON "MediaUnlock"("mediaItemId", "userId");

-- CreateIndex
CREATE INDEX "MediaWatermark_userId_idx" ON "MediaWatermark"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "MediaWatermark_mediaItemId_userId_key" ON "MediaWatermark"("mediaItemId", "userId");
...
-- CreateIndex
CREATE INDEX "ContentOwnership_packId_idx" ON "ContentOwnership"("packId");

-- CreateIndex
CREATE UNIQUE INDEX "ContentOwnership_userId_packId_key" ON "ContentOwnership"("userId", "packId");
